      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-wtm-muted">
          ...
          <div className="card p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Name Field */}
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-wtm-text mb-2">
                  Your Name *
                </label>
                <input
                  type="text"
              ...
              {/* Email Field */}
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-wtm-text mb-2">
                  Email Address *
                </label>
                <input
                  type="email"
              ...
              {/* Message Field */}
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-wtm-text mb-2">
                  Message *
                </label>
                <textarea
                  id="message"
          ...
          <div className="mt-12 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="card p-6 text-center">
                <h4 className="font-semibold text-wtm-text mb-2 font-heading">Sales Inquiries</h4>
                <p className="text-wtm-muted mb-2">Ready to get started?</p>
                <p className="text-wtm-primary font-medium">sales@whatthemenu.com</p>
              </div>
              <div className="card p-6 text-center">
                <h4 className="font-semibold text-wtm-text mb-2 font-heading">Support</h4>
                <p className="text-wtm-muted mb-2">Need help with your account?</p>
                <p className="text-wtm-primary font-medium">support@whatthemenu.com</p>
              </div>
            </div>
          </div>
