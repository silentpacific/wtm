...
const ProfilePage: React.FC = () => {
  ...
  if (authLoading) {
    return <div className="text-center py-12 text-gray-500">Loading authentication...</div>;
  }

  if (!user) {
    return <div className="text-center py-12 text-red-600">Please log in to view your profile.</div>;
  }
    ...
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <h2 className="text-lg font-semibold mb-4 text-gray-900">Account</h2>
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-900">Change Password</label>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="md:col-span-2">
              <label className="block text-sm font-medium mb-2 text-gray-900">Restaurant Name</label>
              <input
                type="text"
            ...
            {profile?.url_slug && (
              <div className="md:col-span-2">
                <label className="block text-sm font-medium mb-2 text-gray-900">Restaurant URL</label>
