    ...
    <header className="bg-white shadow-sm relative">
      ...
      >
        <div className="p-4 flex justify-between items-center border-b">
          <span className="text-xl font-bold text-wtm-text">
            Menu
          </span>
          <button
        ...
        <nav className="flex flex-col p-4 space-y-4">
          <Link to="/demos" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600">
            Demos
          </Link>
          <Link to="/faq" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600">
            FAQ
          </Link>
          <Link to="/contact" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600">
            Contact
          </Link>

          {user && (
            <>
              <Link to="/dashboard/menu-editor" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600">
                Menu Scanner
              </Link>
              <Link to="/dashboard/qr-codes" onClick={() => setIsOpen(false)} className="text-gray-700 hover:text-orange-600">
                QR Codes
              </Link>
              <button
                onClick={() => {
